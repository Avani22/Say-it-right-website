...
$query = $this->db->query('SELECT conferences, description, date, sede, confirmation FROM myconf'); 
...
<?php  
	...
	<section>
		<form name="Register" method="post" action="<?php echo base_url(); ?>index.php/Welcome/myconf_delete_data">
		DELETE CONFERENCE <br><br>
						<input type="text" name="conferences" class="box" placeholder="Enter title for conferences" ><br><br><br>
						
						<button type="submit" name="add" class="button_s" style="float:left; width: 20%; height:5%">DELETE</button><br><br>
		</form>
	</section>
