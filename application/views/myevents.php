...
$query = $this->db->query('SELECT events, description, date, sede, confirmation FROM myevents'); 
...
<?php  
	...
	<section>
		...
		<form name="Register" method="post" action="<?php echo base_url(); ?>index.php/Welcome/myevents_delete_data">
		DELETE EVENT <br><br>
