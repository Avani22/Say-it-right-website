...
$query = $this->db->query('SELECT events, description, date, sede, confirmation FROM events'); 
...
<?php  
	...
	<section>
		<form name="Register" method="post" action="<?php echo base_url(); ?>index.php/Welcome/events_insert_data">
		ADD EVENT <br><br>
