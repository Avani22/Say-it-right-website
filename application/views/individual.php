	...
	<section id="details">
		<div class="container">
				...
				<?php $this->load->library('form_validation'); 
                            ...
                            ?>
            <form name="Register" method="post" action="<?php echo base_url(); ?>index.php/Welcome/individual_insert_data">
				...
				<h1> Welcome to the individual registration</h1>
				...
				<input name="work"    class="box" placeholder="Enter place of work" ><br><br>
				<input name="school"   class="box" placeholder="Enter School" ><br><br>
